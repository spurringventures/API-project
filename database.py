...
def init_database():
    ...
    CREATE INDEX IF NOT EXISTS idx_timestamp ON weather_analysis(timestamp DESC);
    CREATE INDEX IF NOT EXISTS idx_location ON weather_analysis(latitude, longitude);
    CREATE INDEX IF NOT EXISTS idx_photo_timestamp ON weather_analysis(photo_timestamp DESC);
    """
    ...
    try:
        with get_db_connection() as conn:
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
                ...
                # Ensure timestamp is returned as ISO string
                return {
                    "id": result["id"], 
